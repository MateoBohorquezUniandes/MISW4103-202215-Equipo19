...
describe('Editar post', () => {
  ...
  it('Execute scenery feature 2', function(){ 
    ...
    cy.screenshot(screenshotFunction.getStep(Cypress.spec));
    postsPage.openEditorPost(this.data.post_emoji);
    cy.screenshot(screenshotFunction.getStep(Cypress.spec));
    cy.wait(1000);
    postsPage.cleanPostTitle();
    cy.screenshot(screenshotFunction.getStep(Cypress.spec));
    postsPage.writePostTitle(this.data2.post_emoji);
    cy.screenshot(screenshotFunction.getStep(Cypress.spec));
    ...
    cy.screenshot(screenshotFunction.getStep(Cypress.spec));
    postsPage.searchPost(this.data2.post_emoji);
    cy.screenshot(screenshotFunction.getStep(Cypress.spec));
    cy.wait(1000);
    postsPage.getPostTitle(this.data2.post_emoji);
    cy.screenshot(screenshotFunction.getStep(Cypress.spec));
  })
})